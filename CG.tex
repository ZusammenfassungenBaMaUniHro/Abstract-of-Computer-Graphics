...
\section{Curves and Surfaces}
	...
	\begin{itemize}
		...
		\end{center}
		\item We can require the derivatives of x,y and z to each be continuous at joind points
		\item Alternateley we can only require that the tangents of the resulting curve be continuous
	\end{itemize}
	...
	\begin{itemize}
		...
		\end{center}
		\item Bernstein Polynomials: blending function are a special case of the Berstein polynomials $b_{kd} = \frac{d!}{k!(d-k)!}u^{k}(1-u)^{d-k}$, all zeros at 0 and 1, for any degreee they all sum to 1, they are all between 0 and 1 inside (0,1), all Bezier curves lie in the convex hull of their control points
